...
//                                    int tossChoice = (int) (Math.random() * 3);
//                                    switch (tossChoice) {
//                                        case (1):
//                                            System.out.println("Your turn to move. Choose the card (1 - 6):");
//                                            int cardNumber = scanner.nextInt();
//                                            break;
//                                        case (2):
//                                            System.out.println("First attacker: opponent.");
//                                            break;
//                                        default:
//                                            System.out.println("Move has ended up. Your opponent's turn to move.");
//                                            marker = 0;
//                                            break;